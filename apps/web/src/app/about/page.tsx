    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      <div className="mx-auto max-w-4xl px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="mb-2 text-4xl font-bold text-[var(--color-text)]">{tc("about")}</h1>
        ...
        <div className="mb-8 rounded-2xl border border-indigo-500/30 bg-indigo-900/20 p-6 backdrop-blur-sm">
          <h2 className="mb-4 text-xl font-semibold text-[var(--color-text)]">{t("who")}</h2>
        ...
        <div className="mb-8 rounded-lg border border-gray-800 bg-gray-900/50 p-6">
          <h2 className="mb-4 text-xl font-semibold text-[var(--color-text)]">{t("why")}</h2>
        ...
        <div className="mb-8 rounded-lg border border-gray-800 bg-gray-900/50 p-6">
          <h2 className="mb-4 text-xl font-semibold text-[var(--color-text)]">{t("how")}</h2>
          <div className="space-y-4">
            <div>
              <h3 className="mb-2 font-medium text-[var(--color-text)]">{t("developmentApproach")}</h3>
              <p className="text-gray-300">
                {t("developmentApproachDescription")}
              </p>
            </div>
            <div>
              <h3 className="mb-2 font-medium text-[var(--color-text)]">{t("techStack")}</h3>
