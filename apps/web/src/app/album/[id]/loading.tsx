// File: apps/web/src/app/album/[id]/loading.tsx
    ...
    <div className="container mx-auto px-3 py-4 md:px-6 md:py-8">
      ...
      <div className="mb-6 flex flex-col gap-4 md:mb-8 md:flex-row md:gap-6">
        ...
        <div className="flex-shrink-0">
          <div className="aspect-square w-full max-w-[200px] animate-pulse rounded-xl bg-[rgba(255,255,255,0.08)] md:max-w-[300px]" />
        </div>

        {/* Info placeholder */}
        <div className="flex flex-1 flex-col justify-end gap-3">
          <div className="h-3 w-10 animate-pulse rounded bg-[rgba(255,255,255,0.06)]" />
          <div className="h-9 w-64 animate-pulse rounded-lg bg-[rgba(255,255,255,0.1)]" />
          <div className="h-4 w-36 animate-pulse rounded bg-[rgba(255,255,255,0.07)]" />
          <div className="h-3 w-24 animate-pulse rounded bg-[rgba(255,255,255,0.05)]" />
