// File: apps/web/src/app/discover/playlists/[id]/loading.tsx

export default function DiscoverPlaylistLoading() {
  return (
    <div className="container mx-auto px-3 py-4 md:px-6 md:py-8">
      ...
      <div className="mb-6 flex flex-col gap-4 md:mb-8 md:flex-row md:gap-6">
        ...
        <div className="flex flex-1 flex-col justify-end gap-3">
          ...
          <div className="h-4 w-24 animate-pulse rounded bg-[rgba(255,255,255,0.07)]" />
